    ...
    return tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 12:
                    _b.sent();
                    return [4 /*yield*/, createTask('生成rollup打包配置文件(rollup.config.js)', function () { return tslib.__awaiter(void 0, void 0, void 0, function () {
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, copyTemplateFile(getTemplatePath("rollup/rollup.config.temp"), "".concat(workplace, "/rollup.config.js"), {
                                            ts: isUseTS,
                                            web: isNeedServe,
                                            libName: projectName,
                                            port: 8080,
                ...
                case 14:
                    ...
                    return [4 /*yield*/, createTask('执行打包（启动）命令', function (spinner) { return tslib.__awaiter(void 0, void 0, void 0, function () {
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!isUseEslint) return [3 /*break*/, 2];
                                        return [4 /*yield*/, exec('npm run prettier --silent')];
                                    case 1:
                                        _a.sent();
                                        _a.label = 2;
                                    case 2:
                                        if (!(isNeedServe && isStartServe)) return [3 /*break*/, 4];
                                        spinner.success({
                                    ...
                                    case 3:
                                        _a.sent();
                                        return [3 /*break*/, 6];
                                    case 4: return [4 /*yield*/, exec('npm run build:silent --silent')];
                                    case 5:
                                        _a.sent();
                                        _a.label = 6;
                                    case 6:
